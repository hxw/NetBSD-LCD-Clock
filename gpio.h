...
typedef enum {
  //                         Rev1    / Rev2
  GPIO_P1_08 =
      14, //     GPIO_14            Boot to Alt 0 -> UART0_TXD  ALT5 = UART1_TXD
  GPIO_P1_10 =
      15, //     GPIO_15            Boot to Alt 0 -> UART0_RXD  ALT5 = UART1_RXD
  GPIO_P1_12 =
      18, //     GPIO_18            PCM_CLK  ALT4 = SPI1_CE0_N  ALT5 = PWM0
  ...
  GPIO_P1_03 =
      2, //     GPIO_0  / GPIO_2   1K8 pull up resistor I2C0_SDA / I2C1_SDA
  GPIO_P1_05 =
      3, //     GPIO_1  / GPIO_3   1K8 pull up resistor I2C0_SCL / I2C1_SCL
  ...
  // need to change if rev1
  GPIO_P1_13 =
      27, //     GPIO_21 / GPIO_27  PCM_DOUT / reserved  ALT4 = SPI1_SCLK  ALT5
          //     = GPCLK1  ALT3 = SD1_DAT3  ALT4 = ARM_TMS
